...
import { useAppToast } from "../../composables/useToast.ts"
...
<template>
  <aside
    class="sticky top-6 overflow-hidden rounded-[30px] bg-white shadow-xl ring-1 ring-slate-200"
  >
    <!-- HEADER -->
    <div class="border-b border-slate-100 p-6">
      ...
      <div class="flex items-center justify-between">
        ...
        <div
          class="rounded-full bg-blue-50 px-4 py-2 text-sm font-semibold text-blue-600"
        >
          {{ totalItems }}
        </div>
    ...
    <!-- FOOTER -->
    <div
      v-if="items.length && !checkoutSuccess"
    ...
    >
      ...
      <LoadingButton
        ...
        :disabled="!items.length || loadingCheckout"
